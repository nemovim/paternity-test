...
class TripleSiameseNetwork(nn.Module):
    def __init__(self, layer='conn'):
        ...
        self.fc = nn.Linear(2 * 512, 2)  # ResNet18의 output은 512차원
        # Fully convolutional layer
        self.conv = nn.Conv1d(in_channels=2, out_channels=2, kernel_size=512, stride=1)  # 1D convolutional layer
    ...
    def forward(self, img1, img2, img3):
        ...
        if self.layer == 'conn':
            ...
            # Fully convolutional layer
            concat = torch.stack((d1, d2), dim=1)
